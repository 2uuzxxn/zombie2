...
function keyPressed() {
  ...
  if (phase === PHASE_END && keyCode === 32) { phase = PHASE_CREDITS; initCredits(); return; }
  if (phase === PHASE_CREDITS && keyCode === 32) { resetGame(); return; }
...
function mousePressed() {
  ...
  if (phase === PHASE_CREDITS) { resetGame(); return; }
}
